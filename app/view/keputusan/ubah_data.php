                            ...
                            <form id="formUbah" method="post" autocomplete="off">
                                ...
                                <?php foreach ($kriteria as $row) : ?>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="<?= $row['kode_kriteria'] ?>" name="nilai[]" placeholder="Nilai Kriteria <?= $row['nama_kriteria'] ?>" required <?= ($row['kode_kriteria'] == 'K2' ? 'disabled' : null) ?> value="<?= $keputusan->{$row['kode_kriteria']} ?>">
